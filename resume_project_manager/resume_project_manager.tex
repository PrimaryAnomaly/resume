...
\begin{tikzpicture}[remember picture, overlay]
  \node[anchor=north east, inner sep=0pt] at ([xshift=-0.6in, yshift=-0.5in]current page.north east)
    {\includegraphics[width=2.4cm]{../profilepic/profile_pic_cropped.png}};
\end{tikzpicture}
\vspace{-3em}
