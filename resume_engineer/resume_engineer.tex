...
Hands-on hardware-software integration engineer with experience supporting complex experimental systems across embedded electronics, sensors, firmware, PCB development, test infrastructure, and system validation. Built and debugged networked electromechanical platforms for space and research applications using Python, C/C++, and MATLAB, with direct experience in instrumentation, integration testing, and cross-functional technical collaboration. Background spans satellite AIT, embedded sensing platforms, and research software development in university and industry environments.
...
\cvitem{Methods}{Space Hardware AIT, Test Planning, MSPC, Freeze-drying}
\end{minipage}
...
\begin{itemize}[leftmargin=1cm, itemsep=0pt, parsep=0pt]
    ...
    \item Collaborated across engineering and research stakeholders to translate process needs into usable technical tools
...
\begin{itemize}[leftmargin=1cm, itemsep=0pt, parsep=0pt]
    \item Led system integration and validation of military SAR satellites across complex test and assembly campaigns
...
\begin{itemize}[leftmargin=1cm, itemsep=0pt, parsep=0pt]
    ...
    \item Built and validated embedded system prototypes including circuit design, PCB layout, assembly, and system integration
