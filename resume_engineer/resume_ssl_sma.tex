...
Space systems engineer with hands-on experience in satellite integration, embedded electronics, instrument development, and test infrastructure for research and aerospace applications. Built and validated networked electromechanical systems using Python, C/C++, and MATLAB, with direct experience in system integration, electrical test planning, hardware-software troubleshooting, and cross-functional collaboration across engineering teams. Background spans military SAR satellite AIT, CubeSat payload development, and research software development in university and industry environments.

\section{Technical Skills}
\begin{minipage}[t]{0.48\textwidth}
\cvitem{Programming}{Python, C/C++, MATLAB}
\cvitem{Space Systems}{Satellite AIT, Test Planning, Systems Integration}
\cvitem{Embedded}{MCU Firmware, Real-time Systems, Sensors}
\end{minipage}%
\hfill
\begin{minipage}[t]{0.48\textwidth}
\cvitem{Electronics}{Circuit Design, PCB Layout, System Validation}
\cvitem{CAD/Fabrication}{Fusion360, AutoCAD, KiCad, 3D Printing, Laser Cutting, CNC}
\cvitem{Tools}{Git, Docker, Linux}
\cvitem{Methods}{Flight Model Testing, EGSE, ETB, MSPC, Freeze-drying}
\end{minipage}
...
\begin{itemize}[leftmargin=1cm, itemsep=0pt, parsep=0pt]
    ...
    \item Prepared technical documentation and collaborated across engineering and research stakeholders to translate process needs into usable tools
...
\begin{itemize}[leftmargin=1cm, itemsep=0pt, parsep=0pt]
    \item Led system integration and validation of military SAR satellites across complex electrical test and assembly campaigns
    \item Developed and executed Electric Test Bed (ETB) procedures for embedded hardware performance and interface validation
    \item Defined and executed test plans for embedded systems, communications links, and integrated electrical subsystems
    \item Designed high-level Electrical Ground Support Equipment (EGSE) architecture and integration test plans
    \item Developed electrical Integrated Systems Test (IST) plans supporting Flight Model Assembly, Integration, and Testing
    \item Diagnosed and resolved hardware-software interactions in networked systems during integration and validation activities
    \item Contributed to designing a high-throughput satellite manufacturing facility supporting repeatable build and test workflows
\end{itemize}}
...
\begin{itemize}[leftmargin=1cm, itemsep=0pt, parsep=0pt]
    ...
    \item Designed and fabricated multi-modal electrochemical and optical sensor suite for CubeSat payload applications
    \item Developed MCU firmware in C/C++ for real-time sensor data acquisition and autonomous operation
    \item Built and validated embedded system prototypes including circuit design, PCB layout, assembly, and instrument-level integration
